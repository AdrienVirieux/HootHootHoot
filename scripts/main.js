...
//
function addValueInGraph(temperatureIn, temperatureOut) {
    graph.data.datasets[0].data.push({ 'x': new Date(), 'y': temperatureIn });
    graph.data.datasets[1].data.push({ 'x': new Date(), 'y': temperatureOut });
